...
<body>
	<header class="header" id="header">
		...
		<div class="container">
			...
			</figure><h><b>MAHARASHTRA  POLICE</b></h>
			<h1 class="animated fadeInDown delay-07s">WELCOME TO MAHARASHTRA TRAFFIC CONTROL</h1>
			<ul class="we-create animated fadeInUp delay-1s">
				<li>To protect good and to destroy<b> Evil</b></li>
			</ul>
	...
	<nav class="main-nav-outer" id="test">
		...
		<div class="container">
			<ul class="main-nav">
				...
				<li class="small-logo"><a href="#header"><img src="img/mahapose.png" height="70" width="70" alt=""></a></li>
 ...
 <br></p>
	...
	<section class="main-section client-part" id="client">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12">
					<h4 style="font-style: italic; color: white;"> This is Pranit Patil. Development lead at MAHAPOSE.</h4>
				</div>
			</div>
			<ul class="client wow fadeIn delay-05s">
				<li><a href="#">
            	<img src="img/pranit.jpg" height="120" width="120" alt="">
                <h3>Pranit Patil</h3>
            </a></li>
			</ul>
		</div>
	...
	<section class="main-section team" id="team">
		...
		<div class="container">
			<h2>Support Crew</h2>
			<h6>reach out to them in case of emergency</h6>
			<div class="team-leader-block clearfix">
				<div class="team-leader-box">
					<div class="team-leader wow fadeInDown delay-03s">
						<div class="team-leader-shadow"><a href="#"></a></div>
						<img src="img/jim1.jpg" alt="">
					</div>
					<h3 class="wow fadeInDown delay-03s">Jack Ryan</h3>
					<span class="wow fadeInDown delay-03s">Superientendent of Police</span>
				</div>
				<div class="team-leader-box">
					<div class="team-leader  wow fadeInDown delay-06s">
						<div class="team-leader-shadow"><a href="#"></a></div>
						<img src="img/pranit.jpg" width="300" height="300" alt="">
					</div>
					<h3 class="wow fadeInDown delay-06s">Pranit Patil</h3>
					<span class="wow fadeInDown delay-06s">Director General of Police</span>
				</div>
				<div class="team-leader-box">
					<div class="team-leader wow fadeInDown delay-09s">
						<div class="team-leader-shadow"><a href="#"></a></div>
						<img src="img/ted.jpg" width="300" height="300" alt="">
					</div>
					<h3 class="wow fadeInDown delay-09s">Ted Mosby</h3>
			...
			<div class="row">
				<div class="col-lg-6 col-sm-7 wow fadeInLeft">
					<div class="contact-info-box address clearfix">
						...
						<span>Patang Plaza phase 6, dhankwadi, Katraj</span>
					</div>
